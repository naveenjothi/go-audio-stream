...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.AddSongRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_handlers.AddSongRequest": {
            "type": "object",
            "properties": {
                "position": {
                    "type": "integer"
        ...
        "models.Song": {
            ...
            "properties": {
                ...
                "features": {
                    "$ref": "#/definitions/models.SongFeatures"
                },
                "id": {
                    "type": "string"
                },
                ...
                "instruments": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.SongInstrument"
                    }
                },
                "is_suspended": {
                    "type": "boolean"
